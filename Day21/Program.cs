...
Console.WriteLine("Day 21 - Fractal Art");
...
Dictionary<string, string> imageTranslator = new Dictionary<string, string>();
...
static (string input, string output) SplitInput(string input)
{
